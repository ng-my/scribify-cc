            ...
            <template #reference>
              <div @click.stop="handleShowed" class="h-[1.625rem] w-[1.625rem]">
                <span
                  ...
                  class="flex h-[1.625rem] w-[1.625rem] flex-shrink-0 cursor-pointer items-center justify-center rounded-lg transition-all duration-300 hover:bg-menuColor-normal"
                >
