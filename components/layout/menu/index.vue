<template>
  <div>
    <div class="p-4 pb-0 md:hidden">
      <div
        @click="drawer = true"
        class="flex max-w-full cursor-pointer items-center overflow-hidden"
      >
        <client-only>
          <img
            class="relative top-[-1px] z-[1] me-2 h-5 w-5 flex-shrink-0"
            src="/assets/images/home/menu.svg"
            alt=""
          />

          <span
            class="iconfont flex-shrink-0 text-sm"
            :class="name.icon"
          ></span>

          <div
            class="relative top-[1px] z-[1] ms-1 min-w-0 flex-1 truncate text-sm"
          >
            {{ name.name }}
          </div>
        </client-only>
