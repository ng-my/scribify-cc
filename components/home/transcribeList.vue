  ...
  >
    ...
    >
      <div
        ...
        ref="header"
      >
        <span class="me-3 text-sm font-medium sm:me-5 lg:me-6"
        ...
        >
          <div class="flex h-5 items-center">
            <span
              class="iconfont icon-move me-1.5 text-xs text-fontColor sm:text-sm"
            ></span>
          </div>
        ...
        >
          <div class="flex h-5 items-center">
            <span
              class="iconfont icon-xiazai me-1.5 text-xs text-fontColor sm:text-sm"
            ></span>
          </div>
        ...
        <div @click="handleMulDelete" class="common-select !sm:me-0 me-0">
          <div class="flex h-5 items-center">
            <span
              class="iconfont icon-lajixiang relative me-1.5 text-xs text-fontColor sm:text-sm"
            ></span>
          </div>
      ...
      >
        <span
          ...
          class="h-8 overflow-hidden text-ellipsis text-nowrap text-sm font-medium leading-8 text-gray-900"
          >{{ headerName }}</span
        >
      </div>
...
const fetchTableData = async (reset = false) => {
  try {
    ...
    if (err?.toString().includes("signal is aborted")) {
...
.common-select {
  @apply me-2 flex cursor-pointer items-center rounded-lg px-1.5 py-1 hover:bg-[#ECECEC] sm:me-4 lg:me-4 lg:px-2;
}
