  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "W przypadku identyfikacji mówcy pliki są ograniczone do 3 godzin. Proszę odznaczyć 'Identyfikacja Mówcy'."
        }
      }
    },
    upload: {
      link: {
        ...
        title: "Wklej linki",
        label:
          "Wklej link do multimediów z następujących platform, ale nie ograniczając się do: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Dodaj",
        cancel: "Anuluj",
