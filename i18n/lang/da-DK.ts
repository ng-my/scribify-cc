  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "For taler-identifikation er filer begrænset til 3 timer. Venligst fjern markeringen fra 'Taler-identifikation'."
        }
      }
    },
    upload: {
      link: {
        ...
        title: "Indsæt links",
        label:
          "Indsæt medielinket fra følgende platforme men ikke begrænset til: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Tilføj",
        cancel: "Annuller",
        // 请输入正确的链接
        errorTitle:
      ...
      file: {
        ...
        tip1: "Klik for at uploade",
        tip2: "eller træk og slip",
        or: "eller"
      },
      del: {
        title: "Advarsel",
      ...
      speakerLabel:
        "Mærk hvert segment af udskriften med den person, der taler."
    }
  },
  // 转录详情页
  TranscriptionPage: {
