...
let message = {
  ...
  HomePage: {
    ...
    rename: "Hernoemen",
    delete: "Verwijderen",
    createTitle: "Map aanmaken",
    deleteConfirm: `Weet u zeker dat u deze map en alle bestanden erin wilt verwijderen?`,
    cancel: "Annuleren",
    confirm: "Aanmaken",
    dialogLabel: "Mapnaam",
  ...
  FolderPage: {
    table: {
      ...
      activity: "Activiteit",
      empty1: `Het is leeg.`,
      empty2: `Klik op de knop hierboven om een bestand te transcriberen.`,
      just: "zojuist",
      export: "Exporteren",
      delete: "Verwijderen",
      share: "Delen",
  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "Voor sprekerherkenning zijn bestanden beperkt tot 3 uur. Vink 'Sprekerherkenning' uit."
        }
      }
    },
    upload: {
      link: {
        ...
        title: "Links plakken",
        label:
          "Plak de medialink van de volgende platforms maar niet beperkt tot: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Toevoegen",
        cancel: "Annuleren",
  ...
  TranscriptionPage: {
    ...
    notFundDesc: "We konden niet vinden waar u naar zocht.",
    shareTips:
      "Iedereen met de volgende beveiligde link kan deze transcriptie en het bijbehorende mediabestand bekijken.",
    copyLink: "Link kopiëren",
    copySuccessful: "Kopiëren geslaagd",
