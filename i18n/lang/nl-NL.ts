...
let message = {
  ...
  Footer: {
    des: "'s Werelds eerste echt onbeperkte AI-transcriptieservice. Geen beperkingen, geen limieten, alleen de vrijheid om te creëren.",
    Features: "Functies",
    UseCases: "Gebruiksscenario's",
    Company: "Bedrijf",
  ...
  Index: {
    ...
    UseCases: {
      ...
      "journalists": {
        "title": "Journalisten",
        "des": 'Upload al je interviews in één keer. Geen obstakels meer zoals "10 bestanden per maand" wanneer de deadline nadert. Verwerk alles.'
      },
      researchers: {
        title: "Onderzoekers",
        des: "Transcribeer urenlange focusgroepen en interviews. Upload je volledige studie in één keer. Zorg voor nauwkeurige sprekeridentificatie."
      },
      business_teams: {
        title: "Bedrijfsteams",
    ...
    Testimonials: {
      ...
      Sarah: {
        "text": "Ik geef online les en had ondertiteling nodig voor mijn video's. Ik heb drie andere tools geprobeerd, maar die hadden ofwel vreemde beperkingen of duurden een eeuwigheid. Deze... werkt gewoon? Ik heb mijn Spaanse lezing geüpload en had binnen 2 minuten perfecte ondertiteling. Mijn slechthorende studenten zijn er zo blij mee. Had ik dit maar eerder ontdekt!",
        "author": "Sarah Chen",
        "role": "Online leraar"
      },
      Jessica: {
    ...
    CTASection: {
      ...
      "disclaimer": "Geen creditcard vereist voor het gratis abonnement • Upgrade op elk gewenst moment voor onbeperkte toegang"
    }
  },
  Features: {
    ...
    BulkUpload: {
      ...
      useCase1Description: "Upload 3 jaar aan afleveringen in één keer. Maak transcripties van je volledige catalogus. Genereer SEO-content voor elke aflevering.",
      useCase2Title: "Cursuscreatie",
      useCase2Description: "Verwerk al je collegevideo's tegelijk. Maak toegankelijke transcripties voor studenten. Creëer doorzoekbaar cursusmateriaal.",
      ...
      useCase6Description: "Verwerk focusgroepen in bulk. Schrijf alle interviews met deelnemers uit. Analyseer kwalitatieve data efficiënt.",
      ctaTitle: "Stop met smeken om meer uploads",
      ctaSubtitle: "Ontvang onbeperkte bulkverwerking die echt werkt",
      finalCta: "Upload nu 50 bestanden →"
    },
    Accuracy: {
      heroBadgeIcon: "🎯",
      ...
      feature2VisualTitle: "Sprekers geïdentificeerd",
  ...
  Pricing: {
    ...
    CTA: {
      ...
      "button": "Probeer NeverCap gratis →",
      "disclaimer": "Geen creditcard vereist • Begin binnen enkele seconden met transcriberen"
    }
  },
  UseCases: {
    AllUseCases: {
      ...
      podcasters: {
        ...
        description: "Upload je volledige podcastarchief in één keer. Genereer shownotities, verbeter je SEO en hergebruik content zonder minuten te tellen.",
        benefits: {
      ...
      journalists: {
        ...
        description: "Upload alle interviews batchgewijs vóór de deadline. Doorzoek direct transcripties en mis nooit een belangrijk citaat.",
        benefits: {
          benefit1: "Batchupload vóór deadlines",
          benefit2: "Zoek in één keer naar alle interviews",
      ...
      contentCreators: {
        ...
        benefits: {
          benefit1: "Ondertitel alle video's in één keer",
      ...
      researchers: {
        ...
        description: "Verwerk complete onderzoeken in één keer. Organiseer focusgroepen, interviews en paneldiscussies met perfecte sprekeridentificatie.",
        benefits: {
      ...
      businessTeams: {
        ...
        description: "Neem vergaderingen direct op of upload audiobestanden voor directe transcriptie. Creëer doorzoekbare archieven van onbeperkte gesprekken en verlies nooit meer belangrijke discussies.",
        benefits: {
      ...
      quotes: {
        ...
        testimonials: {
          mike: {
            ...
            textAfter: 'zit ongetranscribeerd. Otter wilde dat ik er 3 koos. DRIE. NeverCap liet me alle 150 afleveringen in één weekend uploaden."',
            name: "Mike Rodriguez",
            role: "Podcast-host"
          },
          jessica: {
            ...
            highlight: "$100/maand",
            textAfter: `, maar ik kan ook niet werken met Otter's limiet van 10 bestanden per maand. NeverCap heeft mijn carrière gered."`,
            name: "Jessica Park",
            role: "Freelance journalist"
          },
          sarah: {
      ...
      cta: {
        ...
        subtitle: "Sluit u aan bij de 50.000+ professionals die zijn gestopt met het tellen van minuten en zijn begonnen met het creëren van",
        button: "Begin je onbeperkte reis →"
      }
    },
    Podcasters: {
      badge: "🎙️ Gebouwd voor podcasters",
      ...
      trustBadge1: "🎙️ Meer dan 10.000 podcasters",
      trustBadge2: "∞ Onbeperkt aantal afleveringen",
      trustBadge3: "📝 SEO-klare transcripties",
      stats: {
        stat1: {
          number: "∞",
      ...
      workflow: {
        step1: {
          ...
          description: "Upload 50 afleveringen in één keer. MP3, MP4, WAV - wij regelen het allemaal."
        },
        step2: {
      ...
      ctaDisclaimer: "Geen creditcard vereist • Verwerk onbeperkt afleveringen • Annuleer op elk gewenst moment"
    },
    Journalists: {
      hero: {
        badge: "📰 Voor journalisten en schrijvers",
        title: "Schrijf elk interview uit.",
        titleHighlight: "Mis nooit een citaat.",
        subtitle: "Stop met kiezen welke interviews transcriptie verdienen. Upload alle opnames in één keer, doorzoek alles direct en haal je deadlines zonder uploadstress.",
        ctaPrimary: "Start onbeperkt uploaden →",
        ctaSecondary: "Bekijk hoe het werkt",
        stats: {
          uploads: {
            number: "∞",
      ...
      solution: {
        ...
        solutions: {
          unlimitedUploads: {
            ...
            description: "Nooit meer kiezen welke interviews je wilt transcriberen. Upload 50 bestanden tegelijk. Verwerk maanden aan opnames in één nacht. Je hele onderzoek, getranscribeerd.",
            points: {
      ...
      testimonials: {
        jessica: {
          quote: "Ik had 3 jaar lang interviews die niet waren uitgeschreven vanwege uploadbeperkingen. NeverCap liet me alles in één weekend verwerken. Een game changer.",
          name: "Jessica Park",
    ...
    ContentCreators: {
      hero: {
        ...
        subtitle: "Stop met kiezen welke video's ondertiteling verdienen. Verwerk je volledige YouTube-bibliotheek, genereer ondertitels in meer dan 100 talen en haal video's rechtstreeks op van elk platform. Geen maandelijkse limieten, geen uploadbeperkingen – gewoon pure creatieve vrijheid.",
      ...
      features: {
        ...
        oneClickImport: {
          label: "Importeren met één klik",
          title: "Link plakken.",
          titleHighlight: "Ontvang een transcriptie.",
          description: "Niet meer downloaden en opnieuw uploaden. Plak gewoon je YouTube-, TikTok- of Instagram-link en ontvang direct transcripties. Werk de volledige achterstand van je kanaal in één weekend af.",
          points: {
      ...
      testimonials: {
        ...
        carlos: {
          ...
          highlight: "vertaalt naar het Engels",
          name: "Carlos Martinez",
          role: "YouTube Educator • 250.000 abonnees"
        },
        sarah: {
          textBefore: "Omschrijving gevraagd $30/maand voor",
          textAfter: "Ik heb een achterstand van meer dan 500 video's. NeverCap liet me alles in één weekend verwerken. De SEO-boost van de ondertitels betaalde zich al in de eerste maand terug.",
          highlight: "30 uur",
          name: "Sarah Lee",
        ...
        yuki: {
          ...
          name: "Yuki Tanaka",
          role: "Gaming Creator • 500.000 abonnees"
        }
      },
      cta: {
        title: "Jouw hele kanaal. Met ondertiteling. Vandaag.",
        subtitle: "Sluit je aan bij de 50.000+ makers die zijn gestopt met het tellen van minuten en zijn begonnen met creëren",
        button: "Start onbeperkte ondertiteling →"
      }
    },
    Researchers: {
      ...
      heroSubtitle: "Stop met kiezen welke focusgroepen je wilt transcriberen. Verwerk al je kwalitatieve data met 96% nauwkeurigheid en feilloze sprekeridentificatie – zelfs met 20 deelnemers die door elkaar heen praten.",
      ...
      feature1Label: "Geen grenzen",
      feature1Title: "Verwerk uw volledige studie in één keer",
      ...
      conversationText3: "—sorry dat ik je onderbreek, maar transport is ook heel belangrijk.",
      conversationText4: "Ja! Dat is precies wat ik wilde zeggen.",
      conversationParticipant4: "Deelnemer 4",
      conversationText5: "Op het platteland is er sprake van alle drie: kosten, toegang én transport.",
      ...
      useCase2Desc: "Verwerk honderden één-op-één interviews tegelijkertijd. Behoud consistentie in uw gehele dataset. Doorzoek direct alle transcripties.",
      ...
      useCase5Desc: "Bewaar volledige archieven zonder beperkingen. Creëer doorzoekbare historische documenten. Perfect voor longitudinale en generationele studies.",
    ...
    BusinessTeams: {
      ...
      heroSubtitle: "Neem vergaderingen rechtstreeks in uw browser op of upload direct audiobestanden. Creëer doorzoekbare archieven van onbeperkte gesprekken. Raak nooit meer belangrijke discussies kwijt dankzij echt onbeperkte transcriptie.",
      heroCtaPrimary: "Start nu met opnemen →",
      heroCtaSecondary: "Bekijk hoe het werkt",
      ...
      featuresSubtitle: "Van live-opnames tot directe uploads: we hebben elk knelpunt geëlimineerd",
      feature1Title: "Direct opnemen in uw browser",
      feature1Desc: "Geen downloads, geen plug-ins. Begin direct met opnemen met één klik. Perfecte audiokwaliteit, automatische sprekerdetectie en realtime transcriptie terwijl je spreekt.",
      ...
      feature4Desc: "Zoek in één keer door al je vergaderingen. Vind die cruciale beslissing van het afgelopen kwartaal of die klantbehoefte van maanden geleden. AI-gestuurd zoeken begrijpt context, niet alleen zoekwoorden.",
      feature4Benefit1: "Zoek in één keer naar alle vergaderingen",
      feature4Benefit2: "AI begrijpt context",
      feature4Benefit3: "Filter op spreker of datum",
      feature4SearchPlaceholder: "🔍 Zoeken: 'Q4 omzetdoelstellingen'",
      ...
      workflowStep3Desc: "Actiepunten delen, becommentariëren en extraheren",
      ...
      ctaButton: "Start gratis met opnemen →"
    },
    Educators: {
      ...
      feature1Point3: "Verwerk hele afspeellijsten in één keer",
      ...
      feature3Title: "Organiseren op cursussen en categorieën",
      ...
      feature4Point4: "Meerdere bestanden in één keer in bulk exporteren",
      ...
      useCase5Text: "Deel videocolleges met transcripties vóór de les. Studenten kunnen de lesstof in hun eigen tempo doornemen en voorbereid zijn op discussies.",
  ...
  Privacy: {
    ...
    "identityDescription": "Wanneer u zich aanmeldt voor een van onze producten, vragen we u om identificerende informatie, zoals uw naam en e-mailadres. Dit doen we om essentiële productfunctionaliteit te bieden en om u productupdates en andere essentiële informatie te kunnen sturen.",
  ...
  TermsOfUse: {
    ...
    "freeTrial": "Voor betaalde diensten die een gratis proefperiode aanbieden, leggen we de duur van de proefperiode uit wanneer u zich aanmeldt. Na de proefperiode dient u vooraf te betalen om de dienst te kunnen blijven gebruiken. Als u niet betaalt, worden deze diensten beëindigd.",
    ...
    "cancellationPolicy": "Als u de Service opzegt vóór het einde van de betaalde periode, wordt uw opzegging onmiddellijk van kracht en worden er geen nieuwe kosten in rekening gebracht. We verrekenen ongebruikte tijd in de laatste factureringscyclus niet automatisch.",
    "terminationRights": "We hebben het recht om uw account op te schorten of te beëindigen en om elk huidig of toekomstig gebruik van onze Diensten te allen tijde, om welke reden dan ook, te weigeren. Opschorting betekent dat u geen toegang meer hebt tot het account of de inhoud ervan. Beëindiging zal bovendien leiden tot verwijdering van uw account of uw toegang tot uw account, en tot verbeurdverklaring en overgave van alle inhoud van uw account. We behouden ons tevens het recht voor om het gebruik van de Diensten te allen tijde, om welke reden dan ook, te weigeren. We hebben deze clausule ingevoerd omdat statistisch gezien, van de honderdduizenden accounts op onze Diensten, er minstens één is die iets kwaadaardigs doet.",
    "abusePolicy": "Mondeling, fysiek, schriftelijk of anderszins misbruik (inclusief bedreigingen met misbruik of vergelding) van een werknemer of functionaris van het Bedrijf kan leiden tot onmiddellijke beëindiging van het account.",
    "submissionsTitle": "6. Inzendingen",
    "submissionsDescription": 'U erkent en stemt ermee in dat alle vragen, opmerkingen, suggesties, ideeën, feedback of andere informatie met betrekking tot de Site ("Inzendingen") die u aan ons verstrekt, niet-vertrouwelijk zijn en ons exclusieve eigendom worden. Wij bezitten de exclusieve rechten, inclusief alle intellectuele eigendomsrechten, en hebben recht op het onbeperkte gebruik en de verspreiding van deze Inzendingen voor elk rechtmatig doel, commercieel of anderszins, zonder erkenning of compensatie aan u. U doet hierbij afstand van alle morele rechten op dergelijke Inzendingen en garandeert hierbij dat dergelijke Inzendingen origineel van u zijn of dat u het recht hebt dergelijke Inzendingen in te dienen. U stemt ermee in dat er geen verhaal tegen ons mogelijk is voor enige vermeende of daadwerkelijke inbreuk op of verduistering van enig eigendomsrecht op uw Inzendingen.',
    ...
    "prohibitedExploitation": "U stemt ermee in om geen enkel deel van de Diensten, het gebruik van de Diensten of de toegang tot de Diensten te reproduceren, dupliceren, kopiëren, verkopen, wederverkopen of exploiteren zonder de uitdrukkelijke schriftelijke toestemming van het Bedrijf.",
    ...
    "dmcaPolicy": "Wij respecteren de intellectuele eigendomsrechten van anderen. Als u van mening bent dat materiaal dat beschikbaar is op of via de Site inbreuk maakt op auteursrechten die u bezit of beheert, neem dan onmiddellijk contact met ons op. Een kopie van uw Melding wordt verzonden naar de persoon die het materiaal heeft geplaatst of opgeslagen, waarnaar in de Melding wordt verwezen. Houd er rekening mee dat u volgens de toepasselijke wetgeving aansprakelijk kunt worden gesteld voor schade als u materiële onjuistheden in een Melding vermeldt. Als u er dus niet zeker van bent dat materiaal dat zich op de Site bevindt of waarnaar wordt gelinkt, inbreuk maakt op uw auteursrecht, dient u eerst contact op te nemen met een advocaat.",
    "prohibitedActivitiesTitle": "10. Verboden activiteiten",
    "generalProhibition": "U mag de Site niet bezoeken of gebruiken voor andere doeleinden dan waarvoor wij de Site beschikbaar stellen. De Site mag niet worden gebruikt voor commerciële doeleinden, met uitzondering van die welke specifiek door ons worden onderschreven of goedgekeurd.",
    "userObligations": "Als gebruiker van de Site gaat u ermee akkoord om het volgende niet te doen:",
    "dataScraping": "Systematisch gegevens of andere inhoud van de Site ophalen om, direct of indirect, een verzameling, compilatie, database of directory te creëren of samen te stellen zonder onze schriftelijke toestemming.",
    ...
    "securityInterference": "Het omzeilen, uitschakelen of op andere wijze verstoren van beveiligingsfuncties van de Site, met inbegrip van functies die het gebruik of kopiëren van Inhoud voorkomen of beperken of beperkingen opleggen aan het gebruik van de Site en/of de Inhoud die daarin is opgenomen.",
    ...
    "spyware": 'Materiaal uploaden of verzenden (of proberen te uploaden of verzenden) dat fungeert als een passief of actief mechanisme voor het verzamelen of verzenden van informatie, inclusief maar niet beperkt tot clear graphics interchange formats ("gifs"), 1×1 pixels, web bugs, cookies of andere vergelijkbare middelen (soms ook wel "spyware" of "passieve verzamelmechanismen" of "pcms" genoemd).',
    "disruption": "De Site of de netwerken of diensten die met de Site verbonden zijn, niet hinderen, verstoren of een onnodige belasting voor de Site creëren.",
    ...
    "codeCopying": "De software van de Site kopiëren of aanpassen, met inbegrip van maar niet beperkt tot Flash, PHP, HTML, JavaScript of andere code.",
    ...
    "competition": "De Site niet gebruiken als onderdeel van een poging om met ons te concurreren of de Site en/of de Inhoud op een andere manier gebruiken voor een inkomsten genererende activiteit of commerciële onderneming.",
    ...
    "liabilityTitle": "15. Aansprakelijkheid",
    "liabilityIntroduction": "In deze Voorwaarden wordt aansprakelijkheid veelvuldig besproken, maar om het allemaal in één paragraaf samen te vatten:",
