  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "Para identificação do orador, os ficheiros estão limitados a 3 horas. Por favor, desmarque 'Identificação do Orador'."
        }
      }
    },
    upload: {
      link: {
        ...
        title: "Colar links",
        label:
          "Cole o link de media das seguintes plataformas mas não limitado a: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Adicionar",
        cancel: "Cancelar",
        // 请输入正确的链接
        errorTitle:
      ...
      file: {
        ...
        tip1: "Clique para carregar",
        tip2: "ou arraste e largue",
        or: "ou"
      },
      del: {
        title: "Aviso",
      ...
      speakerLabel:
        "Etiquete cada segmento da transcrição com a pessoa que fala."
    }
  },
  // 转录详情页
  TranscriptionPage: {
