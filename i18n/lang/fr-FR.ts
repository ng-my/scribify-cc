  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "Pour l'identification du locuteur, les fichiers sont limités à 3 heures. Veuillez décocher 'Identification du Locuteur'."
        }
      }
    },
    upload: {
      link: {
        ...
        label:
          "Collez le lien média des plateformes suivantes mais sans s'y limiter : YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Ajouter",
        cancel: "Annuler",
