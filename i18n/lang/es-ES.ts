  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "Para la identificación de hablantes, los archivos están limitados a 3 horas. Por favor, desmarque 'Identificación de Hablantes'."
        }
      }
    },
    upload: {
      link: {
        ...
        title: "Pegar enlaces",
        label:
          "Pega el enlace multimedia de las siguientes plataformas, pero no limitado a: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Añadir",
        cancel: "Cancelar",
        // 请输入正确的链接
        errorTitle:
      ...
      file: {
        ...
        tip1: "Haz clic para subir",
        tip2: "o arrastra y suelta",
        or: "o"
      },
      del: {
        title: "Advertencia",
