  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "For taler-identifikasjon er filer begrenset til 3 timer. Vennligst fjern avkrysningen for 'Taler-identifikasjon'."
        }
      }
    },
    upload: {
      link: {
        ...
        label:
          "Lim inn medielenken fra følgende plattformer men ikke begrenset til: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Legg til",
        cancel: "Avbryt",
        // 请输入正确的链接
        errorTitle:
