...
let message = {
  ...
  HomePage: {
    ...
    deleteConfirm:
      "Bu klasörü ve içindeki tüm dosyaları silmek istediğinizden emin misiniz?",
    cancel: "İptal",
    confirm: "Oluştur",
  ...
  FolderPage: {
    table: {
      ...
      activity: "Etkinlik",
      empty1: "Burası boş.",
      empty2: "Dosyaları yazıya dökmek için yukarıdaki düğmeye tıklayın.",
      just: "Az önce",
      export: "Dışa Aktar",
      delete: "Sil",
      share: "Paylaş",
  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "Konuşmacı tanımlama için dosyalar 3 saatle sınırlıdır. Lütfen 'Konuşmacı Tanımlama'nın işaretini kaldırın."
        }
      }
    },
    upload: {
      link: {
        ...
        label:
          "Aşağıdaki platformların medya bağlantısını yapıştırın, bunlarla sınırlı olmamak üzere: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Ekle",
        cancel: "İptal",
        errorTitle:
  ...
  TranscriptionPage: {
    edit: "Düzenle",
    translate: "Çevir",
    showSpeaker: "Konuşmacıyı Göster",
    showTimestamp: "Zaman Damgasını Göster",
    share: "Paylaş",
    shared: "Paylaşıldı",
    export: "Dışa Aktar",
    speaker: "Konuşmacı_{id}",
    unassignSpeaker: "Konuşmacı Atamasını Kaldır",
    play: "Oynat",
    save: "Kaydet",
    undo: "Geri Al",
    redo: "Yinele",
    ...
    notFund: "Bulunamadı",
    notFundDesc: "Aradığınız şeyi bulamadık.",
    shareTips:
      "Aşağıdaki güvenli bağlantıya sahip olan herkes bu metni ve ilgili medya dosyalarını görüntüleyebilir.",
