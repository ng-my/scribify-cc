  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "For speaker identification, files are limited to 3 hours. Please uncheck 'Speaker Identification'."
        }
      }
    },
    upload: {
      link: {
        ...
        title: "Paste links",
        label:
          "Paste the media link of the following platforms but not limited to: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Add",
        cancel: "Cancel",
        // 请输入正确的链接
        errorTitle:
