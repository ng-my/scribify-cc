  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "A beszélő azonosításhoz a fájlok 3 órára korlátozottak. Kérjük, törölje a pipát a 'Beszélő Azonosítás' mellől."
        }
      }
    },
    upload: {
      link: {
        ...
        label:
          "Illessze be a következő platformok médialinkeit, de nem korlátozódva ezekre: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Hozzáadás",
        cancel: "Mégse",
        // 请输入正确的链接
        errorTitle:
