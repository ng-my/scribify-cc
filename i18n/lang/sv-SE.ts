...
let message = {
  ...
  HomePage: {
    ...
    rename: "Byt namn",
    delete: "Radera",
    createTitle: "Skapa mapp",
    deleteConfirm:
      "Är du säker på att du vill radera denna mapp och alla filer i den?",
    cancel: "Avbryt",
    confirm: "Skapa",
  ...
  FolderPage: {
    table: {
      ...
      date: "Skapad",
      activity: "Aktivitet",
      empty1: "Det är tomt här.",
      empty2: "Klicka på knappen ovan för att transkribera filer.",
      just: "Just nu",
      export: "Exportera",
      delete: "Radera",
      share: "Dela",
  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "För talaridentifiering är filer begränsade till 3 timmar. Vänligen avmarkera 'Talaridentifiering'."
        }
      }
    },
    upload: {
      link: {
        ...
        label:
          "Klistra in medialänken från följande plattformar men inte begränsat till: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Lägg till",
        cancel: "Avbryt",
        errorTitle:
  ...
  TranscriptionPage: {
    edit: "Redigera",
    translate: "Översätt",
    showSpeaker: "Visa talare",
    showTimestamp: "Visa tidsstämpel",
    share: "Dela",
    shared: "Delad",
    export: "Exportera",
    speaker: "Talare_{id}",
    unassignSpeaker: "Ta bort talarassignering",
    play: "Spela",
    save: "Spara",
    undo: "Ångra",
    redo: "Gör om",
    ...
    showVideo: "Visa video",
    hideVideo: "Dölj video",
    langChooseV1: {
      recently: "Nyligen",
      popular: "Populära",
      other: "Andra",
    ...
    notFundDesc: "Vi kunde inte hitta det du letar efter.",
    shareTips:
      "Alla med följande säkra länk kommer att kunna visa denna transkriberade text och tillhörande mediafiler.",
