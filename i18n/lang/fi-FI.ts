  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "Puhujantunnistuksessa tiedostot on rajoitettu 3 tuntiin. Poista valinta kohdasta 'Puhujantunnistus'."
        }
      }
    },
    upload: {
      link: {
        ...
        title: "Liitä linkit",
        label:
          "Liitä median linkki seuraavista alustoista mutta ei rajoittuen niihin: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Lisää",
        cancel: "Peruuta",
        errorTitle:
