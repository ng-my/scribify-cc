...
let message = {
  ...
  HomePage: {
    home: "Startseite",
    version: "Basisversion（Kostenlos）:",
    times:
    ...
    deleteConfirm: `Möchten Sie den Ordner und alle darin enthaltenen Dateien wirklich löschen?`,
    cancel: "Abbrechen",
    confirm: "Erstellen",
  ...
  FolderPage: {
    table: {
      ...
      activity: "Aktivität",
      empty1: `Es ist leer.`,
      empty2: `Klicken Sie oben auf die Schaltfläche, um eine Datei zu transcribieren.`,
      just: "nur",
      export: "Exportieren",
      delete: "Löschen",
      share: "Teilen",
  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        speaker: {
          content:
            "Für die Sprechererkennung sind Dateien auf 3 Stunden begrenzt. Bitte deaktivieren Sie 'Sprechererkennung'."
        }
      }
    },
    upload: {
      link: {
        ...
        label:
          "Fügen Sie den Medienlink der folgenden Plattformen ein, aber nicht beschränkt auf: YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram",
        confirm: "Hinzufügen",
        cancel: "Abbrechen",
      ...
      file: {
        ...
        tip1: "Klicken zum Hochladen",
        tip2: "oder per Drag & Drop",
        or: "oder"
      },
      del: {
        title: "Warnung",
      ...
      speaker: "Sprechererkennung",
      speakerLabel:
        "Beschriften Sie jedes Segment des Transkripts mit der sprechenden Person."
    }
  },
  // 转录详情页
  TranscriptionPage: {
    ...
    showSpeaker: "Sprecher anzeigen",
    showTimestamp: "Zeitstempel anzeigen",
    share: "Teilen",
    shared: "geteilt",
    export: "Exportieren",
    speaker: "Sprecher_{ id }",
    unassignSpeaker: "Sprecher entfernen",
    play: "Abspielen",
    save: "Speichern",
    ...
    applyToAllMatchingSpeakers: "Auf alle übereinstimmenden Sprecher anwenden",
    ...
    copySuccessful: "Erfolgreich kopiert",
    copyFail: "Kopieren fehlgeschlagen",
    closeTrans: "Übersetzung abbrechen",
    upgradeBtn: "Jetzt upgraden",
    upgradeTip30: "Diese Datei überschreitet 30 Minuten.",
    upgradeTipMore:
      "Upgrade auf Scribify Pro, um Dateien bis zu 10 Stunden Länge zu transkribieren",
    errorTips: "Etwas ist schief gelaufen.",
