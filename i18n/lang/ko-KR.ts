...
let message = {
  ...
  Privacy: {
    ...
    "privacyPolicyTitle": "개인정보 보호정책",
    "policyDescription": `본 정책은 NeverCap(이하 ``NeverCap'', ``당사'', ``저희'', ``저희'')가 귀하가 당사의 서비스, 웹사이트(https://www.nevercap.ai/) 및 소프트웨어(이하 ``서비스'')를 이용할 때 귀하의 개인 정보를 수집, 사용 및 공개하는 방식을 설명합니다.`,
